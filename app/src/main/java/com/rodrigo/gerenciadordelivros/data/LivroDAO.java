package com.rodrigo.gerenciadordelivros.data;
...
public class LivroDAO {
    ...
    public List<Livro> list(){
        ...
        try(
                Cursor c = db.query(LivroContract.TABLE_NAME, columns,
                        null,
                        null,
                        null,
                        null,
    ...
    public void update(Livro livro){
        ...
        db.update(LivroContract.TABLE_NAME, values, LivroContract.Columns._ID+"=?",
                new String[]{String.valueOf(livro.getId())});
    }
    public void delete(Livro livro){
        db.delete(LivroContract.TABLE_NAME, LivroContract.Columns._ID+"=?",
                new String[]{String.valueOf(livro.getId())});
    }
}
